...
<div class="text" style="width: 600px;">
    ...
    <br><br>
    <form action="id_modify.php" method="post">
        <div class="members">
            <p class="member_info">
            ...
            <p class="member_info">
                ...
                <textarea class="member" id="new_member_id" name="new_member_id" style="line-height: 1.4" cols="33" rows="1" readonly><?php echo htmlspecialchars($_GET['new_member_id']); ?></textarea>
            </p>

            <br>
            <div style="text-align: center">
                <button type="submit" class="jjim_btn" style="padding: 7px; padding-left:30px; padding-right:30px; ">아이디 수정</button>
            </div>
        </div>
    </form>
