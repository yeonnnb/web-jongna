...
<script>
    ...
    sendPostRequest("reviewSQL.php", storeNumber).then(response => {
        ...
        <div class = "text" style="width: 600px;">
            ...
            <br><br>
           <form action="name_modify.php" method="post">
                <div class="members">
                    <p class="member_info"> 
                        <label>변경 전 닉네임</label>
                    ...
                    <p class="member_info"> 
                        <label>변경 후 닉네임</label>
                        <textarea class="member" id="new_nickname" name="new_nickname" style="line-height: 1.4" cols="33" rows="1"></textarea>
                    </p>
                </div>

                <br>
                <div style="text-align: center">
                    <button type="submit" class="jjim_btn" style="padding: 7px; padding-left:30px; padding-right:30px; ">닉네임 수정</button>
                </div>
            </form>
            <br><br>
        </div>
