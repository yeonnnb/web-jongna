...
<script>
    ...
    sendPostRequest("reviewSQL.php", storeNumber).then(response => {
            ...
            <div class="top_menu" style="align-items:center; display: flex;">
                                <?php
                                        if (!isset($_SESSION['username'])) {
                                                ...
                                                echo '<INPUT class="jjim_btn" style="font-size: 16px;" TYPE="button" value="마이페이지" onClick="javascript:move(\'./welcome_test.php\');">';
                                        }
                                ?>
                        </div>
            <div class="logo">
        ...
        <div class = "text" style="width: 600px;">
            ...
            <br>
            <div style="text-align: center">
                <input class="jjim_btn" style="padding: 7px; padding-left:30px; padding-right:30px;" type="submit" name="com" value="닉네임 수정" onclick="send()">
                <input class="jjim_btn" style="padding: 7px; padding-left:30px; padding-right:30px;" type="submit" name="com" value="아이디 수정" onclick="send()">
                <input class="jjim_btn" style="padding: 7px; padding-left:30px; padding-right:30px;" type="submit" name="com" value="비밀번호 수정" onclick="send()">
            </div>
            <br><br>
        </div>
