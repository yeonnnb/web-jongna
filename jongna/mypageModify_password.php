           ...
           <form action="password_modify.php" method="post">
                <div class="members">
                    ...
                    <p class="member_info"> 
                        ...
                        <textarea class="member" id="new_password" name="new_password" style="line-height: 1.4" cols="33" rows="1"></textarea>
                    </p>
                </div>

                <br>
                <div style="text-align: center">
                    <button type="submit" class="jjim_btn" style="padding: 7px; padding-left:30px; padding-right:30px; ">비밀번호 수정</button>
                </div>
            </form>
            <br><br>
        </div>
